...
export const en: TranslationMap & {
  ...
  connection: {
    ...
    statusDetail: {
      ...
      starting: "The Gateway is starting. Connection retries automatically.",
      restarting: "The Gateway announced a restart. Connection retries automatically.",
      suspending: "The Gateway is preparing to pause new work.",
      suspended: "New work is paused until the Gateway resumes.",
      reconnecting: "Trying to reconnect automatically. Your conversation stays open.",
      restoring: "Connected. Finishing recovery before sending messages.",
      "reload-required":
        "Refresh the dashboard to use the updated Gateway. Finish unsaved edits first.",
      offline: "Open connection settings or retry the connection.",
      outbox: "Unresolved messages in this Gateway’s outbox. Some may need review before sending.",
    },
